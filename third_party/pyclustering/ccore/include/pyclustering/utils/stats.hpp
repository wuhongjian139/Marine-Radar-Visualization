...
/**
 *
 * @brief   Calculates PDF (Probability Distribution Function) for Gaussian
 * (normal) distribution.
 *
...
/**
 *
 * @brief   Calculates CDF (Cumulative Distribution Function) for Gaussian
 * (normal) distribution.
 *
 * @param[in] p_data: data to calculate probability distribution function.
 *
...
/**
 *
 * @brief   Calculates critical values for data with Gaussian distribution for
 * the following significance levels: 15%, 10%, 5%, 2.5%, 1%.
 *
 * @param[in] p_data_size: Data size for that critical values should be
 * calculated.
 *

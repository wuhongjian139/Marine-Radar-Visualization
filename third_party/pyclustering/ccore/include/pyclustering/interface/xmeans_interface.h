...
/**
 *
 * @brief   X-Means result is returned using pyclustering_package that consist
 ...
 *
 * @return  Returns result of clustering - array of allocated clusters in the
 * pyclustering package.
 *
 */
extern "C" DECLARATION pyclustering_package* xmeans_algorithm(

...
/**
 *
 * @brief   Fuzzy C-Means result is returned by pyclustering_package that
 * consist sub-packages and this enumerator provides named indexes for
 * sub-packages.
 *
 */
 ...
 *
 */
extern "C" DECLARATION pyclustering_package* fcm_algorithm(
    const pyclustering_package* const p_sample,
    const pyclustering_package* const p_centers, const double p_m,

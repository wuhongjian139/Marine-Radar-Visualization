...
class ttsas : public bsas {
 private:
  const dataset* m_data_ptr =
      nullptr; /* temporary pointer to data - exists only during processing */
 ...
 public:
  ...
  ttsas(const double p_threshold1, const double p_threshold2,
 ...
 private:
  ...
  void append_to_cluster(const std::size_t p_index_cluster,
                         const std::size_t p_index_point, const point& p_point);

...
/**
 *
 * @brief    Clustering results of CURE algorithm that consists of information
 * about allocated clusters and their representative points and mean value.
 *
 */
class cure_data : public cluster_data {
 ...
 public:
   ...
   * @details  Cluster index should be used to navigate in collections of
   * representative points. An example of representative points of two clusters:
   *           { {{ 1.0, 2.0 }, { 3.4, 4.0 }}, {{ 7.5, 6.3 }, { -1.4, -4.7 }} }
   *           where points { {{ 1.0, 2.0 }, { 3.4, 4.0 }} are related to the
   * first cluster and {{ 7.5, 6.3 }, { -1.4, -4.7 }} to the second.
   *
  ...
  /**
   *
   * @brief    Returns constant reference to representative points of each
   * cluster.
   *
   */
  const representor_sequence& representors() const {
   ...
   * @details  Cluster index should be used to navigate in collections of mean
   * points. An example of mean points of three clusters: { { 1.0, 2.0 }, {
   * 3.4, 4.0 }, { 7.0, 9.1 } } where { 1.0, 2.0 } is mean of the first cluster,
   * { 3.4, 4.0 } - mean of the second and { 7.0, 9.1 } of the third.
   *

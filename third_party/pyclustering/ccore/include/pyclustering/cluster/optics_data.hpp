...
/**
 *
 * @brief    Clustering results of OPTICS algorithm that consists of information
 * about allocated clusters and noise (points that are not related to any
 * cluster), ordering (that represents density-based clustering structure) and
 * proper radius.
 *
 */
class optics_data : public dbscan_data {
 ...
 public:
  /**
   *
   * @brief    Returns reference to cluster-ordering that represents
  ...
  /**
   *
   * @brief    Returns const reference to cluster-ordering that represents
   * density-based clustering structure.
   *
   */
  ...
  /**
   *
   * @brief    Returns reference to optics objects that corresponds to points
   * from input dataspace.
   *
   */
  ...
  /**
   *
   * @brief    Returns const reference to optics objects that corresponds to
   * points from input dataspace.
   *
   */
  const optics_object_sequence& optics_objects() const {
    return m_optics_objects;
  }

  /**
   *
   * @brief    Returns connectivity radius that can be differ from input
   * parameter.
   * @details  It may be changed by OPTICS ('optics') algorithm if there is
   * requirement to allocate specified amount of clusters.
   *
   */

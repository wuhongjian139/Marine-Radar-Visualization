...
/**
 *
 * @brief    Clustering results of BSAS algorithm that consists of information
 * about allocated clusters and their representatives.
 *
 */
class bsas_data : public cluster_data {
 ...
 public:
  ...
  const representative_sequence& representatives() const {

...
/**
 *
 * @brief    Clustering results of K-Means algorithm that consists of
 * information about allocated clusters and centers of each cluster.
 *
 */
class kmeans_data : public cluster_data {
 ...
 public:
   ...
   * @details  In case of default constructor clusters and centers are not
   * stored on each clustering iteration.
   *
   */
  kmeans_data() = default;
  ...
  /**
   *
   * @brief    Constructor that provides flag to specify that clusters and
   * centers changes are stored on each step.
   *
   * @param[in] p_iteration_observe: if 'true' then cluster and centers changes
   * on each iteration are collected.
   *
   */
  ...
  /**
   *
   * @brief    Copy constructor that creates clustering data that is the same to
   * specified.
   *
  ...
  /**
   *
   * @brief    Move constructor that creates clustering data from another by
   * moving data.
   *
   * @param[in] p_other: another clustering data.
   *
 ...
 public:
  /**
   *
   * @brief    Returns reference to centers that correspond to allocated
   * clusters.
   *
   */
  ...
  /**
   *
   * @brief    Returns constant reference to centers that correspond to
   * allocated clusters.
   *
   */
  ...
  /**
   *
   * @brief    Returns 'true' if clusters and centers are collected during
   ...
   *
   */
  const std::vector<dataset>& evolution_centers() const {
    return m_evolution_centers;
  }
   ...
   *
   */
  std::vector<cluster_sequence>& evolution_clusters() {
    return m_evolution_clusters;
  }
   ...
   *
   */
  const std::vector<cluster_sequence>& evolution_clusters() const {
    return m_evolution_clusters;
  }
};

...
/**
 *
 * @brief    Clustering results of K-Medians algorithm that consists of
 * information about allocated clusters and medians of each cluster.
 *
 */
class kmedians_data : public cluster_data {
 ...
 public:
  /**
   *
   * @brief    Returns reference to medians that correspond to allocated
   * clusters.
   *
   */
  ...
  /**
   *
   * @brief    Returns constant reference to medians that correspond to
   * allocated clusters.
   *
   */

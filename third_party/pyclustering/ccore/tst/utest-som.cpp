...
static void template_create_delete(const unsigned int rows,
                                   const unsigned int cols,
                                   const som_conn_type conn_type,
                                   const som_init_type init_type) {
...
TEST(utest_som, create_delete_conn_func_neighbor) {
  template_create_delete(10, 10, som_conn_type::SOM_FUNC_NEIGHBOR,
                         som_init_type::SOM_RANDOM);
}

TEST(utest_som, create_delete_conn_grid_eight) {
  template_create_delete(10, 10, som_conn_type::SOM_GRID_EIGHT,
                         som_init_type::SOM_RANDOM);
}

TEST(utest_som, create_delete_conn_grid_four) {
  template_create_delete(10, 10, som_conn_type::SOM_GRID_FOUR,
                         som_init_type::SOM_RANDOM);
}

TEST(utest_som, create_delete_conn_honeycomb) {
  template_create_delete(10, 10, som_conn_type::SOM_HONEYCOMB,
                         som_init_type::SOM_RANDOM);
}

TEST(utest_som, create_delete_init_centroid) {
  template_create_delete(10, 10, som_conn_type::SOM_FUNC_NEIGHBOR,
                         som_init_type::SOM_RANDOM_CENTROID);
}

TEST(utest_som, create_delete_init_surface) {
  template_create_delete(10, 10, som_conn_type::SOM_FUNC_NEIGHBOR,
                         som_init_type::SOM_RANDOM_SURFACE);
}

TEST(utest_som, create_delete_init_uniform_grid) {
  template_create_delete(10, 10, som_conn_type::SOM_FUNC_NEIGHBOR,
                         som_init_type::SOM_UNIFORM_GRID);
}

static void template_award_neurons(
    const std::shared_ptr<dataset>& data, const unsigned int epouchs,
    const bool autostop, const unsigned int rows, const unsigned int cols,
    const som_conn_type conn_type,
  ...
  size_t expected_capture_points = std::accumulate(
      expected_result.begin(), expected_result.end(), (std::size_t)0);
...
TEST(utest_som, awards_two_clusters_func_neighbor) {
  ...
  std::shared_ptr<dataset> sample_simple_01 =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_award_neurons(sample_simple_01, 100, false, 1, 2,
                         som_conn_type::SOM_FUNC_NEIGHBOR, expected_awards);
  template_award_neurons(sample_simple_01, 100, false, 2, 1,
                         som_conn_type::SOM_FUNC_NEIGHBOR, expected_awards);
}
...
TEST(utest_som, awards_two_clusters_func_neighbor_autostop) {
  ...
  std::shared_ptr<dataset> sample_simple_01 =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_award_neurons(sample_simple_01, 100, true, 1, 2,
                         som_conn_type::SOM_FUNC_NEIGHBOR, expected_awards);
  template_award_neurons(sample_simple_01, 100, true, 2, 1,
                         som_conn_type::SOM_FUNC_NEIGHBOR, expected_awards);
}
...
TEST(utest_som, awards_two_clusters_grid_eight) {
  ...
  std::shared_ptr<dataset> sample_simple_01 =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_award_neurons(sample_simple_01, 100, false, 1, 2,
                         som_conn_type::SOM_GRID_EIGHT, expected_awards);
  template_award_neurons(sample_simple_01, 100, false, 2, 1,
                         som_conn_type::SOM_GRID_EIGHT, expected_awards);
}
...
TEST(utest_som, awards_two_clusters_grid_four) {
  ...
  std::shared_ptr<dataset> sample_simple_01 =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_award_neurons(sample_simple_01, 100, false, 1, 2,
                         som_conn_type::SOM_GRID_FOUR, expected_awards);
  template_award_neurons(sample_simple_01, 100, false, 2, 1,
                         som_conn_type::SOM_GRID_FOUR, expected_awards);
}
...
TEST(utest_som, awards_two_clusters_honeycomb) {
  ...
  std::shared_ptr<dataset> sample_simple_01 =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_award_neurons(sample_simple_01, 100, false, 1, 2,
                         som_conn_type::SOM_HONEYCOMB, expected_awards);
  template_award_neurons(sample_simple_01, 100, false, 2, 1,
                         som_conn_type::SOM_HONEYCOMB, expected_awards);
}
...
TEST(utest_som, awards_clusters_func_neighbor_simple_sample_02) {
  ...
  std::shared_ptr<dataset> sample_simple_02 =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_02);
  template_award_neurons(sample_simple_02, 100, false, 1, 3,
                         som_conn_type::SOM_FUNC_NEIGHBOR, expected_awards);
  template_award_neurons(sample_simple_02, 100, false, 3, 1,
                         som_conn_type::SOM_FUNC_NEIGHBOR, expected_awards);
}
...
TEST(utest_som, awards_clusters_func_neighbor_simple_sample_03) {
  ...
  std::shared_ptr<dataset> sample_simple_03 =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_03);
  template_award_neurons(sample_simple_03, 100, false, 1, 4,
                         som_conn_type::SOM_FUNC_NEIGHBOR, expected_awards);
  template_award_neurons(sample_simple_03, 100, false, 2, 2,
                         som_conn_type::SOM_FUNC_NEIGHBOR, expected_awards);
}
...
TEST(utest_som, double_training) {
  ...
  size_t number_awards =
      std::accumulate(awards.cbegin(), awards.cend(), (std::size_t)0);

  ASSERT_EQ(sample_simple_01->size(), number_awards);
}

static void template_simulate_check_winners(const som_conn_type conn_type,
                                            const bool autostop,
                                            const bool p_reload = false) {
  som_parameters params;
  std::shared_ptr<dataset> sample_simple_01 =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);

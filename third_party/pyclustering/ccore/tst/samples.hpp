...
/**
 *
 * @brief   Samples from set SIMPLE SAMPLE that is used for easy testing of
...
class simple_sample_factory {
 ...
 public:
   ...
   *
   */
  static std::shared_ptr<dataset> create_sample(
      const SAMPLE_SIMPLE p_sample, const bool p_random_order = false);
   ...
   *
   */
  static std::shared_ptr<dataset> create_random_sample(
      const std::size_t p_cluster_size, const std::size_t p_clusters);
};

/**
 *
 * @brief   Samples from set FCPS that is used for functional testing of
 * clustering algorithms.
 *
 */
...
/**
 *
 * @brief   Samples from set FAMOUS that is used for functional testing of
 * clustering algorithms.
 *
 */
enum class FAMOUS_SAMPLE { OLD_FAITHFUL, SAMPLE_IRIS };

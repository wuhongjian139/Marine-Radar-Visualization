...
static void template_parallel_square(const std::size_t p_length) {
  ...
  parallel_for(std::size_t(0), values.size(),
               [&values, &results](const std::size_t p_index) {
...
TEST(utest_parallel_for, square_1_element) { template_parallel_square(1); }

TEST(utest_parallel_for, square_10_elements) { template_parallel_square(10); }

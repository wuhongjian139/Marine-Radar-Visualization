...
static void template_ttsas_length_process_data(
    const dataset_ptr p_data, const double& p_threshold1,
...
TEST(utest_ttsas, allocation_sample_simple_01) {
  ...
  template_ttsas_length_process_data(
...
TEST(utest_ttsas, allocation_one_allocation_sample_simple_01) {
  ...
  template_ttsas_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01),
      10.0, 20.0, expected_clusters_length);
}

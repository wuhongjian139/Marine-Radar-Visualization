...
TEST(utest_interface_kmedians, kmedians_api) {
  ...
  pyclustering_package* kmedians_result =
      kmedians_algorithm(sample.get(), medians.get(), 0.001, 100, &metric);
...
TEST(utest_interface_kmedians, kmedians_api_null_metric) {
  ...
  pyclustering_package* kmedians_result =
      kmedians_algorithm(sample.get(), medians.get(), 0.001, 100, nullptr);
  ASSERT_NE(nullptr, kmedians_result);

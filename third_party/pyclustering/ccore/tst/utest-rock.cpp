...
static void template_length_process_data(
    ...
    const size_t p_cluster_amount, const double p_threshold,
...
TEST(utest_rock, allocation_sample_simple_01) {
  ...
  template_length_process_data(
      ...
      1.0, 2, 0.5, expected_clusters_length);
}
...
TEST(utest_rock, allocation_sample_one_allocation_simple_01) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01),
      5.0, 1, 0.5, expected_clusters_length);
}
...
TEST(utest_rock, allocation_sample_simple_02) {
  ...
  template_length_process_data(
      ...
      1.0, 3, 0.5, expected_clusters_length);
}
...
TEST(utest_rock, allocation_sample_simple_03) {
  ...
  template_length_process_data(
      ...
      1.0, 4, 0.5, expected_clusters_length);
}
...
TEST(utest_rock, allocation_wrong_radius_sample_simple_03) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_03),
      1.7, 4, 0.5, expected_clusters_length);
}
...
TEST(utest_rock, allocation_sample_simple_04) {
  ...
  template_length_process_data(
      ...
      1.0, 5, 0.5, expected_clusters_length);
}
...
TEST(utest_rock, allocation_wrong_radius_sample_simple_04) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_04),
      1.5, 5, 0.5, expected_clusters_length);
}

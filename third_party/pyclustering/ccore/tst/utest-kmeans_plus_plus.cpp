...
void template_kmeans_plus_plus_initialization(const dataset_ptr& p_data,
                                              const std::size_t p_amount,
                                              const std::size_t p_candidates) {
...
TEST(utest_kmeans_plus_plus, no_center_sample_simple_01) {
  ...
  template_kmeans_plus_plus_initialization(
      data, 0, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
}
...
TEST(utest_kmeans_plus_plus, one_center_sample_simple_01) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_kmeans_plus_plus_initialization(
      data, 1, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
}
...
TEST(utest_kmeans_plus_plus, two_centers_sample_simple_01) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_kmeans_plus_plus_initialization(
      data, 2, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
}
...
TEST(utest_kmeans_plus_plus, three_center_sample_simple_01) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_kmeans_plus_plus_initialization(
      data, 3, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
}
...
TEST(utest_kmeans_plus_plus, max_centers_sample_simple_01) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_kmeans_plus_plus_initialization(
      data, data->size(), kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
}
...
TEST(utest_kmeans_plus_plus, one_center_identical_data_01) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_09);
  template_kmeans_plus_plus_initialization(
      data, 1, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
}
...
TEST(utest_kmeans_plus_plus, one_center_identical_data_02) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_12);
  template_kmeans_plus_plus_initialization(
      data, 1, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
}
...
TEST(utest_kmeans_plus_plus, points_less_than_centers) {
  ...
  ASSERT_THROW(
      template_kmeans_plus_plus_initialization(
          data, data->size() + 1, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE),
...
void template_kmeans_plus_plus_medoid_initialization(
    const dataset_ptr& p_data, const std::size_t p_amount,
    const std::size_t p_candidates) {
  kmeans_plus_plus initializer(p_amount, p_candidates);
...
TEST(utest_kmeans_plus_plus, medoids_simple_01_all_range_farthest) {
  ...
  for (std::size_t i = 1; i < data->size(); i++) {
    template_kmeans_plus_plus_medoid_initialization(
        data, i, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
  }
}
...
void template_initialize_kmeans(
    const dataset_ptr& p_data, const std::size_t p_amount,
...
TEST(utest_kmeans_plus_plus, allocation_sample_simple_01) {
  ...
  template_initialize_kmeans(
      data, 2, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE, {5, 5});
}
...
TEST(utest_kmeans_plus_plus, allocation_sample_simple_02) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_02);
  template_initialize_kmeans(
      data, 3, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE, {10, 5, 8});
}
...
TEST(utest_kmeans_plus_plus, allocation_sample_simple_03) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_03);
  template_initialize_kmeans(
      data, 4, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE, {10, 10, 10, 30});
}

TEST(utest_kmeans_plus_plus, allocation_sample_simple_04) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_04);
  template_initialize_kmeans(data, 5,
                             kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE,
                             {15, 15, 15, 15, 15});
}
...
TEST(utest_kmeans_plus_plus, metric_manhattan) {
  ...
  template_kmeans_plus_plus_metric(
      data, 2, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE, metric);
}
...
void template_kmeans_plus_plus_initialization_range(
    const dataset_ptr& p_data, const std::size_t p_amount,
    const std::size_t p_candidate, const index_sequence& p_indexes) {
  kmeans_plus_plus initializer(p_amount, p_candidate);
...
TEST(utest_kmeans_plus_plus, range_sample_simple_01) {
  ...
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_kmeans_plus_plus_initialization_range(
      data, 2, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE, range);
}
...
TEST(utest_kmeans_plus_plus, range_sample_simple_02) {
  ...
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_02);
  template_kmeans_plus_plus_initialization_range(
      data, 3, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE, range);
}
...
TEST(utest_kmeans_plus_plus, indexes_less_than_centers) {
  ...
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  ASSERT_THROW(template_kmeans_plus_plus_initialization_range(
                   data, 2, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE, range),
               std::invalid_argument);
}

void template_kmeans_plus_plus_several_runs(const dataset_ptr& p_data,
                                            const std::size_t p_amount,
                                            const std::size_t p_candidates) {
  ...
  for (std::size_t i = 0; i < attempts; i++) {
    ...
    all_centers.insert(std::end(all_centers), std::begin(centers),
                       std::end(centers));
...
TEST(utest_kmeans_plus_plus, several_runs_simple_farthest_candidates_01) {
  dataset_ptr data =
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01);
  template_kmeans_plus_plus_several_runs(
      data, 2, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
  template_kmeans_plus_plus_several_runs(
      data, 10, kmeans_plus_plus::FARTHEST_CENTER_CANDIDATE);
}

...
static void template_length_process_data(
    const std::shared_ptr<dataset>& p_data, const size_t p_amount_clusters,
    const size_t p_number_represent_points, const double p_compression,
...
TEST(utest_cure, allocation_sample_simple_01) {
  ...
  template_length_process_data(
      ...
      5, 0.5, expected_clusters_length);
}
...
TEST(utest_cure, allocation_sample_simple_01_one_representative) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01), 2,
      1, 0.5, expected_clusters_length);
}
...
TEST(utest_cure, allocation_sample_simple_01_no_compression) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_01), 2,
      5, 0.0, expected_clusters_length);
}
...
TEST(utest_cure, allocation_sample_simple_02) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_02), 3,
      5, 0.5, expected_clusters_length);
}
...
TEST(utest_cure, allocation_sample_simple_03) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_03), 4,
      5, 0.5, expected_clusters_length);
}
...
TEST(utest_cure, allocation_sample_simple_04) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_04), 5,
      5, 0.5, expected_clusters_length);
}
...
TEST(utest_cure, allocation_sample_simple_05) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_05), 4,
      5, 0.5, expected_clusters_length);
}
...
TEST(utest_cure, allocation_sample_simple_08) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_08), 4,
      5, 0.5, expected_clusters_length);
}
...
TEST(utest_cure, allocation_sample_simple_10_one_representative) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_10), 3,
      1, 0.3, expected_clusters_length);
}

TEST(utest_cure, allocation_sample_simple_11) {
  const std::vector<size_t> expected_clusters_length = {10, 10};
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_11), 2,
      5, 0.3, expected_clusters_length);
}
...
TEST(utest_cure, allocation_sample_simple_12) {
  ...
  template_length_process_data(
      simple_sample_factory::create_sample(SAMPLE_SIMPLE::SAMPLE_SIMPLE_12), 3,
      5, 0.3, expected_clusters_length);
}
...
TEST(utest_cure, allocation_hepta) {
  const std::vector<size_t> expected_clusters_length = {30, 30, 30, 30,
                                                        30, 30, 32};
  template_length_process_data(
      fcps_sample_factory::create_sample(FCPS_SAMPLE::HEPTA), 7, 5, 0.3,
...
TEST(utest_cure, allocation_hepta_max_compression) {
  const std::vector<size_t> expected_clusters_length = {30, 30, 30, 30,
                                                        30, 30, 32};
  template_length_process_data(
      fcps_sample_factory::create_sample(FCPS_SAMPLE::HEPTA), 7, 5, 1.0,
      expected_clusters_length);
}
...
TEST(utest_cure, allocation_hepta_one_representative) {
  const std::vector<size_t> expected_clusters_length = {30, 30, 30, 30,
                                                        30, 30, 32};
  template_length_process_data(
      fcps_sample_factory::create_sample(FCPS_SAMPLE::HEPTA), 7, 1, 0.3,
      expected_clusters_length);
}
...
TEST(utest_cure, allocation_hepta_one_cluster_allocation) {
  ...
  template_length_process_data(
      fcps_sample_factory::create_sample(FCPS_SAMPLE::HEPTA), 1, 1, 0.3,
      expected_clusters_length);
}
...
TEST(utest_cure, allocation_tetra) {
  ...
  template_length_process_data(
      fcps_sample_factory::create_sample(FCPS_SAMPLE::TETRA), 4, 5, 0.5,
      expected_clusters_length);
}
...
TEST(utest_cure, allocation_lsun) {
  ...
  template_length_process_data(
      fcps_sample_factory::create_sample(FCPS_SAMPLE::LSUN), 3, 5, 0.3,
      expected_clusters_length);
}
...
TEST(utest_cure, allocation_two_diamonds) {
  ...
  template_length_process_data(
      fcps_sample_factory::create_sample(FCPS_SAMPLE::TWO_DIAMONDS), 2, 5, 0.5,
      expected_clusters_length);
}
...
TEST(utest_cure, allocation_wing_nut) {
  ...
  template_length_process_data(
      fcps_sample_factory::create_sample(FCPS_SAMPLE::WING_NUT), 2, 4, 0.3,
      expected_clusters_length);
}
...
TEST(utest_cure, allocation_chainlink) {
  ...
  template_length_process_data(
      fcps_sample_factory::create_sample(FCPS_SAMPLE::CHAINLINK), 2, 10, 0.3,
      expected_clusters_length);
}

...
static void template_create_delete(const unsigned int num_osc,
...
static void template_simulation(const legion_stimulus& stimulus,
                                const connection_t type,
                                const solve_type solver,
                                const unsigned int steps, const double time) {
  legion_parameters parameters;
...
TEST(utest_legion, one_unstimulated_oscillator_rk4) {
  template_simulation({0}, connection_t::CONNECTION_NONE,
                      solve_type::RUNGE_KUTTA_4, 10, 100);
}

TEST(utest_legion, one_stimulated_oscillator_rk4) {
  template_simulation({1}, connection_t::CONNECTION_GRID_FOUR,
                      solve_type::RUNGE_KUTTA_4, 10, 100);
}
...
TEST(utest_legion, dynamic_simulation_grid_four_rk4) {
  template_simulation({1, 1, 1, 0, 0, 0, 1, 1, 1},

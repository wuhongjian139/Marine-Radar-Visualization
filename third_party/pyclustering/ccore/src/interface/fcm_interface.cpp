...
pyclustering_package *fcm_algorithm(const pyclustering_package *const p_sample,
                                    ...
                                    const double p_m, const double p_tolerance,
  ...
  ((pyclustering_package **)package->data)[FCM_PACKAGE_INDEX_CLUSTERS] =
      create_package(&output_result.clusters());
  ((pyclustering_package **)package->data)[FCM_PACKAGE_INDEX_CENTERS] =
      create_package(&output_result.centers());
  ((pyclustering_package **)package->data)[FCM_PACKAGE_INDEX_MEMBERSHIP] =
      create_package(&output_result.membership());

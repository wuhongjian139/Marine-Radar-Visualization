...
void *cure_algorithm(const pyclustering_package *const sample,
  ...
  pyclustering::clst::cure solver(number_clusters, number_repr_points,
                                  compression);

  pyclustering::clst::cure_data *output_result =
      new pyclustering::clst::cure_data();
...
pyclustering_package *cure_get_clusters(void *pointer_cure_data) {
  pyclustering::clst::cure_data &output_result =
      (pyclustering::clst::cure_data &)*(
          (pyclustering::clst::cure_data *)pointer_cure_data);

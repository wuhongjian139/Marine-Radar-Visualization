...
bsas::bsas(const std::size_t p_amount, const double p_threshold,
           const distance_metric<point> &p_metric)
    : m_threshold(p_threshold), m_amount(p_amount), m_metric(p_metric) {}
...
void bsas::update_representative(const std::size_t p_index,
                                 const point &p_point) {

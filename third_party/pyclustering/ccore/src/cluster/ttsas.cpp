...
ttsas::ttsas(const double p_threshold1, const double p_threshold2,
...
void ttsas::append_to_cluster(const std::size_t p_index_cluster,
...
void ttsas::allocate_cluster(const std::size_t p_index_point,
                             const point &p_point) {
